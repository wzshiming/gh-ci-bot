...
function reset_env() {
    ...
    unset MESSAGE PLUGINS AUTHOR_PLUGINS MEMBERS_PLUGINS REVIEWERS_PLUGINS \
        ...
        OWNERS_AREAS OWNERS_AREA_APPROVERS OWNERS_LABELS OWNERS_LOAD_FAILED \
        branch \
        GITHUB_RUN_ID GITHUB_REPOSITORY GITHUB_SERVER_URL \
        MOCK_GH_FAIL MOCK_CURL_FAIL \
        MOCK_PR_FILES_JSON MOCK_OWNERS_FILE MOCK_OWNERS_DIR MOCK_OWNERS_FAIL \
        MOCK_OWNERS_FAIL_PATH MOCK_PR_BASE_JSON MOCK_COMMENTS_JSON \
        MOCK_COMMENTS_FAIL MOCK_MUTATE_FAIL
}

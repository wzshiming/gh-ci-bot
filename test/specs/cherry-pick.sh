...
SHA="abc1234"
CREATE_PR="gh pr create -R wzshiming/example --base release-1.0 --head cherry-pick-1-to-release-1.0 --title [release-1.0] Fix the fonts --body Cherry-pick of #1 to \`release-1.0\`."
...
log_has_line "git checkout -b cherry-pick-1-to-release-1.0"
log_has_line "git cherry-pick -m 1 ${SHA}"
log_has_line "git push origin cherry-pick-1-to-release-1.0"

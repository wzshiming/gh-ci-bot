...
| `/[remove-]ok-to-test`            | `/ok-to-test`</br>`/remove-ok-to-test`                 | Approves workflow runs of the PR awaiting maintainer approval (e.g. from public forks) and applies the 'ok-to-test' label so runs of future pushes are approved automatically.       | ok-to-test             |

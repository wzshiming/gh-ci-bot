...
| `/[remove-]ok-to-test`            | `/ok-to-test`</br>`/remove-ok-to-test`                 | Applies or removes the 'ok-to-test' label. Applying it approves the PR's workflow runs awaiting maintainer approval (e.g. from public forks) and auto-approves runs of future pushes. | ok-to-test             |
